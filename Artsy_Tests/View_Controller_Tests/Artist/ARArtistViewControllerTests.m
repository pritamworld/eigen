...
itHasSnapshotsForDevicesWithName(@"artworks masonry", ^{
    ...
    networkModel.artworksForArtworksAtPage = [Artwork arrayOfModelsWithJSON:@[
        @{ @"id" : @"some-artist-artwork-1",
           @"availability" : @"for sale" },
        @{ @"id" : @"some-artist-artwork-2",
           @"availability" : @"not for sale" },
        @{ @"id" : @"some-artist-artwork-3",
           @"availability" : @"not for sale" }
    ]];
...
itHasSnapshotsForDevicesWithName(@"two-rows artworks masonry", ^{
    ...
    networkModel.artworksForArtworksAtPage = [Artwork arrayOfModelsWithJSON:@[
        ...
        @{ @"id" : @"some-artist-artwork-3",
           @"availability" : @"for sale" },
        @{ @"id" : @"some-artist-artwork-4",
           @"availability" : @"for sale" },
        @{ @"id" : @"some-artist-artwork-5",
           @"availability" : @"not for sale" },
        @{ @"id" : @"some-artist-artwork-6",
           @"availability" : @"not for sale" },
        @{ @"id" : @"some-artist-artwork-7",
           @"availability" : @"not for sale" },
        @{ @"id" : @"some-artist-artwork-8",
           @"availability" : @"not for sale" },
        @{ @"id" : @"some-artist-artwork-9",
           @"availability" : @"not for sale" },
        @{ @"id" : @"some-artist-artwork-10",
           @"availability" : @"not for sale" },
    ]];
...
itHasSnapshotsForDevicesWithName(@"when showing for sale artworks", ^{
    ...
    networkModel.forSaleArtworksForArtworksAtPage = [Artwork arrayOfModelsWithJSON:@[
        @{ @"id" : @"some-artist-artwork-11",
           @"availability" : @"for sale" },
        @{ @"id" : @"some-artist-artwork-12",
           @"availability" : @"for sale" },
        @{ @"id" : @"some-artist-artwork-13",
           @"availability" : @"for sale" },
        @{ @"id" : @"some-artist-artwork-14",
           @"availability" : @"for sale" },
    ]];
