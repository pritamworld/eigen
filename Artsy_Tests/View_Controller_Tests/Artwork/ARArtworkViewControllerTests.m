...
beforeEach(^{
    [OHHTTPStubs stubJSONResponseAtPath:@"/oauth2/access_token" withResponse:@{ @"access_token" : @"token",
                                                                                @"expires_in" : @"2034-11-11" }];
    ...
    [OHHTTPStubs stubJSONResponseAtPath:@"/api/v1/artwork/some-artwork" withResponse:@{ @"id" : @"some-artwork",
                                                                                        @"title" : @"Some Title" }];
});
