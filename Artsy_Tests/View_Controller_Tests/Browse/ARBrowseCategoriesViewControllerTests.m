...
before(^{
    ...
    [OHHTTPStubs stubJSONResponseAtPath:@"/api/v1/sets"
                             withParams:@{ @"key" : @"browse:featured-genes",
                                           @"mobile" : @"true",
                                           @"published" : @"true",
                                           @"sort" : @"key" }
                           withResponse:@[ @{ @"id" : @"featured-genes",
                                              @"name" : @"Featured Categories",
                                              @"item_type" : @"FeaturedLink" } ]];

    // used to find the set called "Gene Categories"
    [OHHTTPStubs stubJSONResponseAtPath:@"/api/v1/sets"
                             withParams:@{ @"key" : @"browse:gene-categories",
                                           @"published" : @"true",
                                           @"mobile" : @"true",
                                           @"sort" : @"key" }
                           withResponse:@[ @{ @"id" : @"featured-categories",
    ...
    [OHHTTPStubs stubJSONResponseAtPath:@"/api/v1/set/featured-categories/items"
                           withResponse:@[ @{ @"id" : @"subject-matter-genes",
                                              @"name" : @"Subject Matter Genes",
                                              @"item_type" : @"FeaturedLink" },
                                           @{ @"id" : @"mew-media-genes",
                                              @"name" : @"New Media Genes",
                                              @"item_type" : @"FeaturedLink" } ]];
